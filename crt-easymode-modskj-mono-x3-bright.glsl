...
#define TARGET_GAMMA_INPUT 1.8
#define TARGET_GAMMA_OUTPUT 1.85
#define TARGET_BRIGHT_BOOST 1.01
...
#		endif
		{
			...
			if (dot_no == 0) {
				mask_weight = XYZ_VECTOR3_T(1.34,  1.34, 1.34);
			}
			else
			if (dot_no == 1) {
				mask_weight = XYZ_VECTOR3_T(1.0,  1.0, 1.0);
				
			}
			else {
				mask_weight = XYZ_VECTOR3_T(0.54,  0.54, 0.54);
			}
